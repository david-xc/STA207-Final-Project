...
popden1 <- read.csv("Data/populationDensitycsvData.csv",
               header = FALSE)
...
In the future, we can further study the relationship of different factor is smaller scale level. For example we can focus on the data of different states in the US or even counties in California. In this way, it is possible to discover more detailed factors which have influence on the covid-19 situation.
# References
